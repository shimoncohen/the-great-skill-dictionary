...
| cloudflare/skills | Official skills for building on Cloudflare | ![Stars](https://img.shields.io/github/stars/cloudflare/skills?style=flat-square&label=%E2%AD%90) | Apache-2.0 | [GitHub](https://github.com/cloudflare/skills) |
| expo/skills | Official skills for Expo projects and Expo Application Services | ![Stars](https://img.shields.io/github/stars/expo/skills?style=flat-square&label=%E2%AD%90) | MIT | [GitHub](https://github.com/expo/skills) |
| google/skills | Official agent skills for Google products and technologies | ![Stars](https://img.shields.io/github/stars/google/skills?style=flat-square&label=%E2%AD%90) | Apache-2.0 | [GitHub](https://github.com/google/skills) |
| huggingface/skills | Official skills for the Hugging Face ecosystem covering models, datasets, and ML workflows | ![Stars](https://img.shields.io/github/stars/huggingface/skills?style=flat-square&label=%E2%AD%90) | Apache-2.0 | [GitHub](https://github.com/huggingface/skills) |
| muratcankoylan/agent-skills-for-context-engineering | Skills for context engineering, multi-agent architectures, and production agent systems | ![Stars](https://img.shields.io/github/stars/muratcankoylan/agent-skills-for-context-engineering?style=flat-square&label=%E2%AD%90) | MIT | [GitHub](https://github.com/muratcankoylan/agent-skills-for-context-engineering) |
...
| vercel-labs/agent-skills | Vercel official collection of agent skills for React, Next.js, and web development | ![Stars](https://img.shields.io/github/stars/vercel-labs/agent-skills?style=flat-square&label=%E2%AD%90) | — | [GitHub](https://github.com/vercel-labs/agent-skills) |
